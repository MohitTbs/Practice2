...
public class TestConfig{
	...
	public static String from = "tbs.mohitk@gmail.com"; //"corporate@way2automation.com"
	public static String password = "Mohit@1234";
	public static String[] to ={"tbs.priyankag@gmail.com"};  //{"seleniumcoaching@gmail.com","trainer@way2automation.com"}
